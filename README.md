...
- To run your assemblies, you will need to change [this line](https://github.com/karlsonmodding/Loadson/blob/main/Launcher/App.xaml.cs#L106) from `true` to `false` to bypass the bootstrapper.
